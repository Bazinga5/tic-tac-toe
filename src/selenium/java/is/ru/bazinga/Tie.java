...
public class Tie {
  ...
  public void testTie() throws Exception {
    ...
    driver.findElement(By.xpath("//table[@id='board']/tbody/tr[2]/td/a")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (!isElementPresent(By.cssSelector(".is_loading"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    ...
    driver.findElement(By.xpath("//table[@id='board']/tbody/tr/td[2]/a")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (!isElementPresent(By.cssSelector(".is_loading"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    ...
    driver.findElement(By.xpath("//table[@id='board']/tbody/tr[3]/td[3]/a")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (!isElementPresent(By.cssSelector(".is_loading"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    ...
    driver.findElement(By.xpath("//table[@id='board']/tbody/tr/td[3]/a")).click();
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (!isElementPresent(By.cssSelector(".is_loading"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
